...
<form>
	<div id="writeBox">
		...
		<div id="inputUnderDiv">
			<input id="inputUnderTitle" type="text">
		</div>
		<div id="writeTitle">
			<h4>글 작성하기</h4>
			<div id="inputUnderDiv2">
				<input id="inputUnderContent" type="text">
			</div>
		</div>
	</div>
	</form>
	<div class="btn">
		<button id="sub_btn" onclick="history.back()">취소</button>
		<button id="btn-save"  class="">작성</button>
	</div>
